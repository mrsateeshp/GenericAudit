...
public abstract class ApiNgOperations {
    ...
    public abstract boolean cancelOrders(String marketId, List<CancelInstruction> cancelInstructions, String appKey, String ssoId) throws APINGException;

    public abstract  List<Order> listCurrentOrders(String marketId, OrderProjection orderProjection, String appKey, String ssoId) throws APINGException ;

    public abstract  ProfitAndLossReport listMarketProfitAndLoss(String marketId, String appKey, String ssoId) throws APINGException ;
